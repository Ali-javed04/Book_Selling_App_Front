...
class PreferenceManager private constructor() {
    ...
    fun removeActiveUser() {
        ...
        prefEditor.putString(Constants.USER_CITY, Constants.UNDEFINED)
    ...
    fun setUserCity(city: String) {
        prefEditor.putString(Constants.USER_CITY, city)
        prefEditor.commit()
    }
    fun getUserCity(): String? {
        return pref.getString(Constants.USER_CITY, Constants.UNDEFINED)
    ...
    fun setUserPhone(phone: String) {
        prefEditor.putString(Constants.USER_CITY, phone)
        prefEditor.commit()
    }
